...
export function TelemetryHUD({ hoveredCoords, mapLayers, onToggleLayer }: TelemetryHUDProps) {
  ...
  return (
    <footer 
      ...
      className="z-50 px-6 py-2 theme-bg-panel border theme-border flex gap-6 text-[10px] font-mono shadow-2xl backdrop-blur-md clip-chamfer theme-text-secondary items-center"
    >
      ...
      <div className="flex items-center border-l theme-border pl-6 relative">
        <button
        ...
        {/* Floating popover for layer selection */}
        {isOpen && (
          <div className="absolute bottom-12 right-0 theme-bg-panel border theme-border p-3 rounded-lg shadow-xl w-64 flex flex-col gap-1.5 z-55 pointer-events-auto animate-fadeIn">
            {/* Popover Header */}
